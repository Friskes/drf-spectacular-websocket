...
<div class="row justify-content-center">
  <img class="img-fluid text-center" src="![](https://github.com/Friskes/drf-spectacular-websocket/blob/master/images/example_send.png?raw=True)">
</div>

### Receive
<div class="row justify-content-center">
  <img class="img-fluid text-center" src="![](https://github.com/Friskes/drf-spectacular-websocket/blob/master/images/example_receive.png?raw=True)">
</div>
